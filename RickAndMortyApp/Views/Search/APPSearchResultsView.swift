...
protocol APPSearchResultsViewDelegate: AnyObject {
...
///
final class APPSearchResultsView: UIView {

    weak var delegate: APPSearchResultsViewDelegate?
...
extension APPSearchResultsView: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return locationCellViewModels.count
    }

    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: APPLocationTableViewCell.cellIdentifier,
                                                       for: indexPath) as? APPLocationTableViewCell else {
            fatalError("Failed to dequeue APPLocationTableViewCell")
        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.appSearchResultsView(self, didTapLocationAt: indexPath.row)
    }
}

// MARK: - CollectionView

extension APPSearchResultsView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let characterVM = currentViewModel as? APPCharacterCollectionViewCellViewModel {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        switch viewModel.results {
        case .characters:
            delegate?.appSearchResultsView(self, didTapCharacterAt: indexPath.row)
        case .episodes:
            delegate?.appSearchResultsView(self, didTapEpisodeAt: indexPath.row)
        case .locations:
            break
        }
    }
...
extension APPSearchResultsView: UIScrollViewDelegate {
