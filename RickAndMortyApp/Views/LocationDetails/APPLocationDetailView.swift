...
protocol APPLocationDetailViewDelegate: AnyObject {
...
final class APPLocationDetailView: UIView {

    public weak var delegate: APPLocationDetailViewDelegate?
