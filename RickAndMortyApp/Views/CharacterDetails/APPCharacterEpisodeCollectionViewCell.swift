...
class APPCharacterEpisodeCollectionViewCell: UICollectionViewCell {
    static let cellIdentifer = "APPCharacterEpisodeCollectionViewCell"
    ...
    public func configure(with viewModel: APPCharacterEpisodeCollectionViewCellViewModel) {
