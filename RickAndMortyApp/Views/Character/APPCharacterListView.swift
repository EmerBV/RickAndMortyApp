...
protocol APPCharacterListViewDelegate: AnyObject {
    func appCharacterListView(
        _ characterListView: APPCharacterListView,
        didSelectCharacter character: APPCharacter
    )
}
...
final class APPCharacterListView: UIView {
    ...
    public weak var delegate: APPCharacterListViewDelegate?
...
extension APPCharacterListView: APPCharacterListViewViewModelDelegate {
    func didSelectCharacter(_ character: APPCharacter) {
        delegate?.appCharacterListView(self, didSelectCharacter: character)
    }
