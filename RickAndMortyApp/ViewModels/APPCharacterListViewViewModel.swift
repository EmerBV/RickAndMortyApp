//
//  APPCharacterListViewViewModel.swift
//  RickAndMortyApp
//
...
protocol APPCharacterListViewViewModelDelegate: AnyObject {
...
final class APPCharacterListViewViewModel: NSObject {
    ...
    public weak var delegate: APPCharacterListViewViewModelDelegate?
    ...
    public func fetchCharacters() {
        APPService.shared.execute(
            ...
            expecting: APPGetAllCharactersResponse.self
        ) { [weak self] result in
            switch result {
...
extension APPCharacterListViewViewModel: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout
{
